...
- Checked which Azure region is allowed on your subscription
  - Policy > Compliance > (Azure for Students) > View Assignments > ~ Allowed regions
...
| Container App | `inh-ccd-lab1-app-mh26` |
| Container Apps environment | `inh-ccd-lab1-env-mh26` |
...
3. **Basics** tab:
   ...
   - **Resource group:** `inh-ccd-lab1-<suffix>`
   - **Container app name:** `inh-ccd-lab1-app-<suffix>`
   - **Region:** West Europe
   - **Container Apps Environment:** **Create new**
     - Name: `inh-ccd-lab1-env-<suffix>`
